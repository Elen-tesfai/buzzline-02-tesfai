...
def process_message(message: str) -> None:
    ...
    """
    logger.info(f"Processing message: {message}")  # Log the message being processed
...
def main() -> None:
    ...
    try:
        for message in consumer:
            ...
            logger.debug(f"Received message at offset {message.offset}: {message_str}")  # Debug log
