...
py -m producers.kafka_producer_tesfai
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m producers.kafka_producer_tesfai
```
...
```shell
.venv\Scripts\activate
py -m consumers.kafka_consumer_tesfai
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m consumers.kafka_consumer_tesfai
```
